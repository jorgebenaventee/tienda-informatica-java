package dev.clownsinformatics.tiendajava.rest.auth.services;
...
import dev.clownsinformatics.tiendajava.rest.auth.services.authentication.AuthenticationServiceImpl;
...
public class AuthenticationServiceImplTest {
    ...
    @Test
    public void testSignIn_WhenUserNotFound_ShouldThrowException() {
        // Datos de prueba
        UserSignInRequest request = new UserSignInRequest();
        request.setUsername("testuser");
        request.setPassword("password");
