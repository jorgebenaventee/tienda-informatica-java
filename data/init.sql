...
DROP DATABASE IF EXISTS "tienda-informatica";
--
-- Name: tienda-informatica; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE "tienda-informatica" WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'en_US.utf8';
